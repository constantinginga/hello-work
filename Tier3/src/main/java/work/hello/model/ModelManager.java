...
public class ModelManager implements Model
{
  ...
  @Override public void createJobListing(JobListing jobListing)
  {
  ...
  @Override public JobSeeker createJobSeeker(JobSeeker jobSeeker)
  {
    return mongoDB.createJobSeeker(jobSeeker);
  }

  @Override public Employer createEmployer(Employer employer)
  {
  ...
  @Override public JobListing getJobListing(String id)
  {
    return mongoDB.getJobListing(id);
  }
}
